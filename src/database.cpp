...
const std::array<figureQestions,N> questionFigure = 
  {
    ...
    figureQestions{L"Лена хочет подарить родным N ракушек. Ей осталось найти M ракушек . Сколько ракушек Лена уже нашла ?",calc},
    figureQestions{L"В корзине было N ягод клубники. После того , как Игорь съел несколько ягод, осталось M. Сколько ягод съел Игорь ?",calc},
    figureQestions{L"Ване нужно найти N грибов. Ему осталось найти M грибов. Сколько грибов он уже нашел ?",calc}
