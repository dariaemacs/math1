...
const std::wstring CommentsDic[] =
{
    ...
    {L"Осталось времени:" },
    {L" мин" },
    {L"ИТОГООВАЯ РАБОТА ПО МАТЕМАТИКЕ ДЛЯ" },
    {L"1 - ГО КЛАССА"},
    {L"Прочитай и выполни задания. В работе 16" },
    {L"заданий. Постарайся выполнить все задания." },
    {L"Желаем тебе успеха!" },
    {L"На работу дается 40 минут" },
    {L"Потраченное время: " },
    {L" минут " },
    {L" минуты " },
    {L" секунд " },
