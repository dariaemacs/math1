...
extern const int question6Variants[] = { 6,8,7,9 };
...
extern const figureQestions question14Text[] = { figureQestions{L"Рассмотри таблицу.",calc}};

extern const std::wstring question14Text1[] = { 
L"В таблице записано, какие игрушки есть у ребят.", 
L"В таблице записано, какие животные есть у ребят.",
L"В таблице записано, какие шарики есть у ребят.",
};

extern const std::wstring question14Text2[3][3] = {
{L"Какая игрушка есть у одинакового количества мальчиков и девочек?",
 L"Сколько всего мальчиков и девочек имеют мячиков?",
 L"На сколько меньше девочек, чем мальчиков имеют машинки?"},

{   L"Какое животное есть у одинакового количества мальчиков и девочек?",
    L"У скольких мальчиков и девочек есть хомяки?",
    L"На сколько больше мальчиков, чем девочек имеют собак?"},
{
    L"Какого цвета шарики есть у одинакового количества мальчиков и девочек?",
    L"Сколько всего мальчиков и девочек имеют синие шарики?",
    L"На сколько больше девочек, чем мальчиков имеют красные шарики?",
}
};
extern const std::wstring question14TextColumn[3][4] = {
    {L"Название игрушки", L"Мячик", L"Мишка", L"Машинка"},
    {L"Название животного", L"Хомяк", L"Кошка", L"Собака"},
    {L"Цвет шариков", L"Красные", L"Синие", L"Зеленые"}
};

extern const std::wstring question14TextVariant[3][3] = {
            {L"Мячик",  L"Мишка", L"Машинка"},
...
extern const int question16Answer[3] = { 6,6,13 };
extern const int question16AnswerString[3] = { 2,2,0 };
